...
export const LIST_START = 'PRODUCT_LIST_START'
export const LIST_FAILED = 'PRODUCT_LIST_FAILED'
export const LIST_SUCCEED = 'PRODUCT_LIST_SUCCEEDT'
export const LIST_SELECT = 'PRODUCT_LIST_SELECT'
const pageSize = 200;
