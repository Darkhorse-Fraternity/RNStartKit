...
const ButtonStyle = styled.View`
  backgroundColor: ${props => props.disabled?props.theme.Button.disabledBackgroundColor:
...
const Button = props => {
    const { children : label, icon, iconPlacement, submitting, theme, style,...rest } = props
    ...
    return (
        <ButtonWrapper>
            <Touchable {...rest}>
                <ButtonStyle theme={theme} {...rest} style={style}>
                    <ButtonTextWrapper>
